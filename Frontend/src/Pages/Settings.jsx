...
export default function Settings() {
    ...
    const { image } = useSelector((state) => state.user.userData)
    ...
    return (
        <div className=" text-white   flex flex-col w-screen items-start mb-40">
                ...
                <div className=" flex gap-10">
                    ...
                    <div className=" flex flex-col w-[50%] gap-5">
                        ...
                        <input style={{
                            ...
                            className="w-full rounded-[0.5rem] bg-richblack-800 p-[12px] text-richblack-5" type="text" name="firstName" id="firstName" />
                        ...
                        <input style={{
                            ...
                            className="w-full rounded-[0.5rem] bg-richblack-800 p-[12px] text-richblack-5" type="number" name="ph" id="ph" />
                    ...
                    <div className=" flex flex-col w-[50%] gap-5">
                        ...
                        <input style={{
                            ...
                            className="w-full rounded-[0.5rem] bg-richblack-800 p-[12px] text-richblack-5" type="text" name="profession" id="profession" />
            ...
            <button className="bg-yellow-50 text-black py-2  rounded-lg gap-2 flex justify-center items-center px-6  self-end   "> Submit</button>
